  ...
  return (
    <div className='border-4 border-black'>
      <div className='grid grid-cols-5'>
        ...
        <CanvasCard title={'2. 목표 고객'} notes={canvas.customerSegments.notes} />
        <CanvasCard title={'기존 대안'} isSubtitle notes={canvas.existingAlternatives.notes} />
        <CanvasCard title={'8. 핵심지표'} notes={canvas.keyMetrics.notes} />
        <CanvasCard title={'상위개념'} isSubtitle notes={canvas.highLevelConcept.notes} />
        <CanvasCard title={'9. 고객 경로'} notes={canvas.channels.notes} />
        <CanvasCard title={'얼리 어답터'} isSubtitle notes={canvas.earlyAdopters.notes} />
      </div>
